jQuery(document).ready(function($) {
  $(document).ready(function() {
    ...
    $(".hamburger").on("click", function() {
      var o = $(".page-header"),
        l = $(".page-header__nav");
      o.hasClass("is-opened")
        ? (o.removeClass("is-opened"),
          l.slideUp("slow").removeClass("is-opened"),
          (function() {
            var o = parseInt($("html").css("top"), 10);
            $("html").removeClass("disable-scrolling"),
              $("html,body").scrollTop(-o);
          })())
        : (o.addClass("is-opened"),
          l.slideDown("slow").addClass("is-opened"),
          (function() {
