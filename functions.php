 ...
 */
 ...
 function theme_setup() {
  ...
  add_theme_support( 'menus' );
 	...
 	register_nav_menus( array(
 		'header-main-menu' => esc_html__( 'Header Menu', 'header-menu' ),
 	) );
 ...
 function theme_js() {
   ...
   wp_enqueue_script( 'mainsalJS', get_template_directory_uri() . '/js/sal.js', array('jquery'), '', true);
	wp_enqueue_script( 'faJS', 'https://kit.fontawesome.com/9cf512b134.js', true);
